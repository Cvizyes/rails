...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { nombre: @library.nombre, telefono: @library.telefono } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { nombre: @library.nombre, telefono: @library.telefono } }
